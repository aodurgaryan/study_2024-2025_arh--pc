...
4. Провожу компиляцию шаблона с использованием Makefile. Для этого ввожу команду make
 ...
 5. Удаляю полученные файлы с использованием Makefile. Для этого ввожу команду make clean 
 
 ![рис 5](image/5.png){#fig:001 width=100%}
 
 6. Открываю файл report.md c помощью любого текстового редактора, например gedit report.md 
 ...
 8. Отправляю отчет на гитхаб
 
 ![рис 7](image/8.png){#fig:001 width=100%}
